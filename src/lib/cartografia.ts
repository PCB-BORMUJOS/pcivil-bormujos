...
export const CAPAS_TEMATICAS: CapaOficial[] = [
    {
        ...
        descripcion: 'Límite administrativo oficial del municipio (cartografía andaluza, más precisa a escala local que el límite nacional generalizado).',
        categoria: 'tematica',
        grupo: 'Territorio',
        wmsUrl: 'https://www.ideandalucia.es/services/DERA_g13_limites_administrativos/wms',
        wmsLayers: 'g13_01_TerminoMunicipal',
        wmsVersion: '1.1.1',
        wmsFormat: 'image/png',
        transparente: true,
    ...
    // ── Relieve y topografía ────────────────────────────────────────────────
    {
        ...
        descripcion: 'Curvas de nivel del MDT de Andalucía. Base para el plano de relieve del PTEL, coherente con el resto de cartografía andaluza del visor.',
        categoria: 'tematica', grupo: 'Relieve',
        wmsUrl: 'https://www.ideandalucia.es/services/DERA_g1_relieve/wms',
        wmsLayers: 'g01_03_CurvaNivel',
