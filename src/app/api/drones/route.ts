    ...
    if (tipo === 'vuelo') {
      ...
      const vuelo = await prisma.vuelo.create({
        data: {
          ...
          categoriaAESA: data.categoriaAESA || null,
          municipio: data.municipio || 'Bormujos',
          lugarDespegue: data.lugarDespegue || null,
          lugarAterrizaje: data.lugarAterrizaje || null,
          descripcionZona: data.descripcionZona || null,
          zonaAerea: data.zonaAerea || null,
          ...
          alturaMedia: data.alturaMedia ? parseFloat(data.alturaMedia) : null,
          condicionesMeteo: data.condicionesMeteo || {},
          condicionesVuelo: data.condicionesVuelo || null,
          notamConsultado: data.notamConsultado || false,
          notamReferencia: data.notamReferencia || null,
          objetivoMision: data.objetivoMision || null,
          resultadoMision: data.resultadoMision || null,
          personalApoyo: data.personalApoyo || null,
          numeroVccOperador: data.numeroVccOperador || null,
          incidencias: data.incidencias || null,
          observaciones: data.observaciones || null,
          bateriasUsadas: data.bateriasUsadas || null,
